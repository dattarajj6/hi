<!--
*******************************XML**********************************************
<…..create folder in xampp\htdocs……http://localhost/books/books.xml…… >
<?xml version="1.0"?>
        ...
        <html>
            <head>
                <style>
                    ...
                    .author {
                        color: blue; /* Author column color */
                        font-weight: bold;
                        text-transform: uppercase; /* Capitalize author names */
                    }
                    .title {
                        color: green; /* Title column color */
                    }
                    .isbn {
                        color: orange; /* ISBN column color */
                    }
                    .publisher {
                        color: purple; /* Publisher column color */
                    }
                    .edition {
                        color: brown; /* Edition column color */
                    }
                    .price {
                        color: red; /* Price column color */
                    }
                </style>
            </head>
            <body>
